...
{
    //BU METOT SAYESNDE SSTEM RESMI OTMATIK OLARAK SLIDER ILE EKLEYECEK
    //[] array türünde datayı temsil eder

    protected $guarded = [];

    static function InsertorUpdate($data = [] , $chapter, $chapterSub, $dataId, $isImage = 0, $imageFolder ="")
    {
        foreach ($data as $k => $v) {
