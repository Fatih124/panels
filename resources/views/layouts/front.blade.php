...
<head>
    ...
    @foreach(\App\Language::all() as $k => $v)
        <link rel="alternate" href="http://localhost/panels/public/{{$v['code']}}" hreflang="{{$v['code']}}">
    @endforeach
        ...
        <div class="container">
            <div class="top-content-wrap row">
                ...
                <div class="col-md-4 d-none d-md-block">
                    <ul class="right-info">
                        @foreach(\App\Language::all() as $k => $v)
                        <li><a href="{{ route('front.lang', ['lang'=>$v['code']]) }}">{{$v['code']}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="bottom-content-wrap row">
                ...
                <div class="col-md-9 d-none d-md-block text-right">
                    ...
                    <a href="#online-offer" class="default-btn">Teklif Al</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="widget-section padding">
    <div class="container">
        <div class="widget-wrap row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 sm-padding">
                <div class="widget-content">
                    <li><a href="">@lang("general.recent_blog")</a></li>
                </div>
            </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="subscribe-wrap">
                        <form action="{{ route('front.newsletter') }}" method="POST" class="subscribe-form">
                            @csrf
                            <input type="email" required name="email" id="email" class="form-input" placeholder="@lang("general.your_email")">
...
<script src="https://unpkg.com/sweetalert/dist/sweetale"></script>
    @if(session("swal"))
        <script>swall("{{session("swal")}}");</script>
    @endif
