                    ...
                    <div class="mT-30">
                        <form enctype="multipart/form-data" action="{{ route('admin.slider.update',['id'=>$id]) }}" method="POST">
                            ...
                            @foreach(\App\Language::all() as $k => $v)
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="{{asset(\App\LanguageContent::get($v['id'],SLIDER_LANGUAGE,IMAGE_LANGUAGE,$id))}}" style="width: 100px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="title[{{$v['id']}}]" id="exampleInputEmail1" value="{{\App\LanguageContent::get($v['id'], SLIDER_LANGUAGE, TITLE_LANGUAGE, $id )}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
