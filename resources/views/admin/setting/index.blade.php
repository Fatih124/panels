                                ...
                                <div class="row" style="border: 1px solid #dddddd; margin-bottom: 5px;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description[{{$v['id']}}]" value="{{ \App\LanguageContent::get($v['id'],SITE_SETTING_LANGUAGE, DESCRIPTION_LANGUAGE,1) }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Site Keyword[{{$v['name']}}]</label>
                                            <input type="text" name="keywords[{{$v['id']}}]" value="{{ \App\LanguageContent::get($v['id'],SITE_SETTING_LANGUAGE, KEYWORDS_LANGUAGE,1) }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Site Footer Text[{{$v['name']}}]</label>
                                            <input type="text" name="footer_text[{{$v['id']}}]" value="{{ \App\LanguageContent::get($v['id'],SITE_SETTING_LANGUAGE, FOOTER_TEXT_LANGUAGE,1) }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Banner Title[{{$v['name']}}]</label>
                                            <input type="text" name="banner_title[{{$v['id']}}]" value="{{ \App\LanguageContent::get($v['id'],SITE_SETTING_LANGUAGE, BANNER_TITLE_LANGUAGE,1) }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Banner Description[{{$v['name']}}]</label>
                                            <input type="text" name="banner_description[{{$v['id']}}]" value="{{ \App\LanguageContent::get($v['id'],SITE_SETTING_LANGUAGE, BANNER_DESCRIPTION_LANGUAGE,1) }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
