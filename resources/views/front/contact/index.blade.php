            ...
            <div class="row contact-wrap">
                <div class="col-md-6 xs-padding">
                    <div class="contact-info">
                        ...
                        <ul>
                            <li><i class="ti-location-pin"></i> {{ \App\Setting::get('phone') }}</li>
                            <li><i class="ti-mobile"></i>{{\App\Setting::get("email")}}</li>
                    ...
                    <div class="contact-form">
                        ...
                        <form action="{{route('front.contact.store')}}" method="post" class="form-horizontal">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-12">
                                    <button id="submit" class="default-btn" type="submit">@lang("general.send")we</button>
                                </div>
                            </div>
