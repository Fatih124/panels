            ...
            <div class="row">
                <div class="col-lg-9 sm-padding">
                    <div class="blog-items single-post row">
                        ...
                        <p>{!! \App\LanguageContent::getText(BLOG_LANGUAGE,$data[0]['id']) !!}</p>

                        <div class="share-wrap">
                            <h4>Share This Article</h4>
                            <ul class="share-icon">
                                <li><a href="https://www.facebook.com/sharer.php?uwe={{url()->current()}}"><i class="ti-facebook"></i> Facebook</a></li>
                                ...
                                <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{url()->current()}}&title={{\App\LanguageContent::getName(BLOG_LANGUAGE,$data[0]['id'])}}&summary={text}&source={provider}"><i class="ti-linkedin"></i> Linkedin</a></li>
                            </ul>
                        </div><!-- Share Wrap -->
                            ...
                            <ul id="comments-list" class="comments-list">
                                <li>
                                    <div class="comment-main-level">
                                        <!-- Avatar -->
                                        <div class="comment-avatar"> <img src="{{asset('front/img/comment-1.jpg')}}" alt="comment"> </div>
                                    ...
                                    <ul class="comments-list reply-list">
                                        <li>
                                            <!-- Avatar -->
                                            <div class="comment-avatar"> <img src="{{asset('front/img/comment-2.jpg')}}" alt="comment"> </div>
                                            <!-- Contenedor del Comentario -->
                                            <div class="comment-box">
                                                <div class="comment-head">
                                                    <h6 class="comment-name"><a href="">{{ \App\User::getName(\App\CommentAnswer::getField($v['id'],"userId")) }}</a></h6>
