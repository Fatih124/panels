                    ...
                    <div class="table-cell">
                        <div class="container">
                            <div class="slider-text">
                                <h1 class="wow cssanimation fadeInTop" data-wow-delay="1s" data-wow-duration="800ms">{!! \App\LanguageContent::get(\App\Helper\mHelper::getLanguageId(),SLIDER_LANGUAGE,TITLE_LANGUAGE,$v['id']) !!}</h1><!-- !!(çift ünlem) ile çağrıldığı zaman html kodlarını okur yazılmadan çağrılırsa html kodlarını okumaz düz yazı şeklinde basar-->
                                ...
                                <a href="{{\App\LanguageContent::get(\App\Helper\mHelper::getLanguageId(),SLIDER_LANGUAGE,URL_LANGUAGE,$v['id'])}}" class="default-btn wow cssanimation fadeInBottom" data-wow-delay="0.8s">@lang('general.slider_go_to_detail')</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @foreach($projects as $k => $v)
                    <div class="project-item">
                        ...
                        <div class="project-content">
                            ...
                            <span class="date">{{ date("Y-m-d",strtotime($v['created_time'])) }}</span>
