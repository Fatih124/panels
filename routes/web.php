...
Route::group([
    ...
    Route::get('en/sitemap.xml', 'indexController@enSitemap');
    ...
    Route::group(['namespace'=>'contact','as'=>'contact.'],function(){
        ...
        Route::post(LaravelLocalization::transRoute('routes.store'),'indexController@store')->name('store');
    });
});
Route::group(['namespace'=>'admin','prefix'=>'admin', 'as' =>'admin.', 'middleware'=>['auth']],function (){
    ...
    Route::group(['namespace'=>'comment', 'as'=>'comment.', 'prefix'=>'comment'],function(){
        ...
        Route::post('/answer/store/{id}', 'indexController@store')->name('store');
        Route::get('/', 'indexController@index')->name('index');
        Route::post('/data', 'indexController@data')->name('data');
        Route::get('delete/{id}','indexController@delete')->name('delete');
    });
    ...
    Route::group(['namespace'=>'newsletter', 'prefix'=>'newsletter', 'as'=>'newsletter.'],function (){
        Route::get('/', 'indexController@index')->name('index');
        Route::post('/data', 'indexController@data')->name('data');
        Route::get('delete/{id}','indexController@delete')->name('delete');
